...
export const useAnalytics = () => {
    ...
    const analytics = useMemo(() => {
        ...
        // Calculate "Risk Items" (Atoms with low mastery)
        // Mastery is 0-5. Low mastery < 2.
        const riskItems = atoms.filter(a => a.mastery < 2).length;

        // 2. Focus Efficiency (專注效率)
        // Convert history object to array for charts: [{ date: '2023-10-01', minutes: 45 }]
        // Get last 7 days
        const focusTrends = Object.entries(timerHistory)
