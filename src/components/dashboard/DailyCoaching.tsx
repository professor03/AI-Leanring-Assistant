...
import type { MoodState, PetType } from '../../types';
...
interface DailyCoachingProps {
  ...
  mood: MoodState;
  onMoodChange: (next: MoodState) => void;
  selectedPet: PetType;
...
const DailyCoaching = ({
  ...
  return (
    <div className="space-y-4">
      ...
      <MoodSurvey value={mood} onChange={onMoodChange} />
      <PetSelector selected={selectedPet} onSelect={onSelectPet} />
